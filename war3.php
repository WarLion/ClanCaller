 ...
 <a href="callit.php?e=<?php echo $i;?>&a=3" class="btn btn-success" style="margin-top:80px;">Call it</a>
        ...
        <?php } } } }else{?>
            <ul class="list-unstyled">
                    ...
                    <li><p  class="user_title" style="text-align: center; font-size:15; color:#FFF;"><?php echo $caller['user_username3'];?></p></li>
         <?php    
        ...
        while($score = mysqli_fetch_array($result_score)){ 
          ?>  
                    <li><a href="#myModal_call_3_enemy_<?php echo $i;?>" data-toggle="modal"><img src="imagenes/th/<?php if($score['score'] == NULL){echo 'none';}else{ echo $score['score'];}?>.png" width="80" /></a></li>
   <!-- timer -->
           <?php 
		   if ($score['score'] == NULL){
...
<div class="modal fade bs-example-modal-sm" id="myModal_call_3_enemy_<?php echo $i;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
